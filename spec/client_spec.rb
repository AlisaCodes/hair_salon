...
describe(Client) do
  ...
  describe("#==") do
    it("is the same list if it has the same name") do
      test_client1 = Client.new({:name => "Buzz", :phone_number => "555 555 555", :stylist_id => 1})
      test_client2 = Client.new({:name => "Buzz", :phone_number => "555 555 555", :stylist_id => 1})
      expect(test_client1).to(eq(test_client2))
    end
  end

  describe('#name') do
    it('returns the name of the test_client') do
      test_client = Client.new({:name => "Buzz", :phone_number => "555 555 555", :stylist_id => 1})
      expect(test_client.name()).to(eq("Buzz"))
    end
  end
  ...
  #     test_client = Client.new({:name => "Buzz", :phone_number => "555 555 555", :id => 1})
  #     test_client.save()
  ...
  describe('#save') do
    it('saves instance to an array') do
      test_client = Client.new({:name => "Buzz", :phone_number => "2001-01-01", :stylist_id => 1})
      test_client.save()
